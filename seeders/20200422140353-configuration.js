...
module.exports = {
  up: (queryInterface, Sequelize) => {
    const default_config = {
      ...
      color_scheme: 2,
      choose_sizes: 1,
      footer_text: `2020 © ${config.app.title} by <a href='https://www.cowlar.com/'>Cowlar</a>`,
      fb: "",
      twitter: "",
      google: "",
      account_layout: 2,
      ...
      company_address:
        "Plot 5-A (Crown Plaza), 2nd Floor, Above Hatim Supermarket, F-7 Markaz Islamabad, Pakistan",
      company_phone: "+92 (51) 831 7562",
      company_email: "team@cowlar.com",
