...
exports.admin_email = process.env.ADMIN_EMAIL || "admin.viaphoton@cowlar.com";
exports.admin_password = process.env.ADMIN_PASSWORD || "123456";

exports.admind_email =
...
exports.device_role_user_email =
  process.env.DEVICE_ROLE_USER_EMAIL || "testorgdevice.viaphoton@cowlar.com";
exports.device_role_user_password =
  process.env.DEVICE_ROLE_USER_PASSWORD || "123456";

exports.super_admin_email = "superadmin.viaphoton@cowlar.com";
exports.super_admin_password = "123456";

exports.admin_email = "admin.viaphoton@cowlar.com";
...
exports.get_token_for = async (role = "superadmin", getNewToken = false) => {
  ...
  if (!getNewToken && global.auth_tokens && global.auth_tokens[role]) {
    ...
    if (role == "superadmin") {
      ...
      params.email = "testsuperadmin.viaphoton@cowlar.com";
